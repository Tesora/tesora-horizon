...
class ClusterInstanceManager(object):
    ...
    def add_instance(self, id, name, flavor, volume, type, related_to):
        instance = ClusterInstance(id, name, flavor, volume, type, related_to)
...
class ClusterInstance(object):
    def __init__(self, id, name, flavor, volume, type, related_to):
        self.id = id
        self.name = name
        self.flavor = flavor
        self.volume = volume
